...
var createClassPartObject = (nextPart = /* @__PURE__ */ new Map(), validators$1 = null, classGroupId) => ({
	nextPart,
...
var getGroupRecursive = (classParts, startIndex, classPartObject) => {
	...
	const validators$1 = classPartObject.validators;
	if (validators$1 === null) return;
	const classRest = startIndex === 0 ? classParts.join(CLASS_PART_SEPARATOR) : classParts.slice(startIndex).join(CLASS_PART_SEPARATOR);
	const validatorsLength = validators$1.length;
	for (let i = 0; i < validatorsLength; i++) {
		const validatorObj = validators$1[i];
